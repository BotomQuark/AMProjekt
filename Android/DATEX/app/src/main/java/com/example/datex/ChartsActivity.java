...
public class ChartsActivity extends AppCompatActivity {
    ...
    private final double dataGraph1MaxY =  100.0d;
    ...
    private final double dataGraph2MaxY =  100.0d;
    ...
    private void sendGetRequest()
    {
        ...
        String url = getURL(DATA.DEFAULT_IP_ADDRESS);
    ...
    private void drawcharts(double temp, double press, double humi)
    {
        ...
        dataSeries1.appendData(new DataPoint(timeStamp, temp), scrollGraph1, dataGraph1MaxDataPointsNumber);
        ...
        dataSeries2.appendData(new DataPoint(timeStamp, press), scrollGraph2, dataGraph2MaxDataPointsNumber);
        ...
        dataSeries3.appendData(new DataPoint(timeStamp, humi), scrollGraph3, dataGraph3MaxDataPointsNumber);
